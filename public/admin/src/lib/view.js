    ...
    view.req = function (options) {
        ...
        return $.ajax($.extend({
            ...
            , success: function (res) {
                ...
                //只有 response 的 code 正常才执行 done
                if ($.inArray(res[response.statusName], statusCode.ok) !== -1) {
    ...
    Class.prototype.render = function (views, params) {
        ...
        $.ajax({
            ...
            , error: function (e) {
                ...
                if (e.status === 404) {
                    that.render('tips/404');
                } else {
                    that.render('tips/error');
                }
